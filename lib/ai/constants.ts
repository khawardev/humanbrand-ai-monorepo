...
export const GEMINI_MODEL_NAME = "gemini-2.5-pro-preview-05-06"; // HBAI Model 2
export const OPENAI_MODEL_NAME = "gpt-4.1"; // HBAI Model 1
...
// ----- AIAG Brand Guidelines (Based on KB v4) -----
...
// ----- Contextual Awareness Prompt Template (GLOBAL DEFINITION) -----
// NOTE: Renamed to UPPER_SNAKE_CASE to follow common TypeScript constant naming conventions.
