            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-xs text-muted-foreground px-1">
                        Upload a <strong>square</strong> image to guide the generation or to apply edits.
                    </p>
                    ...
                    >
                        {isPending ? (
                            <ButtonSpinner>
                                {hasUploadedImage ? "Applying Edits..." : "Dreaming..."}
                            </ButtonSpinner>
                        ) : (
                            <div className="flex items-center gap-2">
                                <span>{hasUploadedImage ? "Generate AI Edit" : "Generate Image"}</span>
                            </div>
                        )}
                    </Button>
                </div>
