...
export const modelTabs = [
    { id: 2, label: 'openai', title: "Core", tooltip: "Fast and efficient for everyday tasks" },
    { id: 3, label: 'gemini', title: "Advanced", tooltip: "Enhanced reasoning and analysis capabilities" },
    { id: 4, label: 'claude', title: "Ultra", tooltip: "Maximum creativity and complex problem solving" },
];
