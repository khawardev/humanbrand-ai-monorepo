"use client";
import { ArrowRight, Bot, Check, ChevronDown, Gift, Paperclip, Speech } from "lucide-react";
...
export default function AI_Prompt() {
    ...
    return (
            <div className="bg-background/5 border dark:bg-white/5 rounded-2xl p-1.5 pt-4">
                <div className="flex items-center gap-2 mb-2.5 mx-2 ">
                    <div className="flex-1 flex items-center gap-2">
                        <Image className=" rounded-full" src={'https://i.postimg.cc/ZYDgZQyF/aiag-logo.jpg'} alt="" width={20} height={20} />
                        <p className="text-black font-semibold dark:text-white/90 text-xs tracking-tighter">
