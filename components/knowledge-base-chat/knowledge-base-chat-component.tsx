...
export default function KnowledgeBaseChatComponent() {
    const { user, chatHistory, isLoading, isResponding, handleSendMessage } = useKnowledgeBaseChat();
            ...
            <DropdownMenuContent className="rounded-xl w-[350px] p-3" align='end'>
                <div className="flex flex-col h-[70vh]">
                    {isLoading ? <div className='flex-center min-h-[70vh]'> <LuLoaderCircle className="text-muted-foreground size-4 animate-spin" /></div> :
                        <>
                            <div ref={chatContainerRef} className="flex flex-col overflow-y-auto space-y-4 ">
