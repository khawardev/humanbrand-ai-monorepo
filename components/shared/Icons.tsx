...
import { Container, WalletCards } from "lucide-react";
...
export const Icons = {
  ...
  download: ({ size, className }: any) => (
    <MdOutlineFileDownload className={className} size={size} />
  ),

  brands: ({ size }: any) => (
    <WalletCards size={size} />
  ),
  suppliers: ({ size }: any) => (
    <Container size={size} />
  ),
  ...
  logout: ({ size }: any) => (
    <HiOutlineLogout   size={size} />
  ),
  logo: ({ size, className }: any) => (
    <FaHashnode className={className} size={size} />
  ),
  products: ({ size }: any) => (
    <TbShoppingCartCog size={size} />
  ),
