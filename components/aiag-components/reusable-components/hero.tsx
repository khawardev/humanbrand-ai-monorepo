                ...
                <div className="div-center-md md:py-12 py-0">
                    <div className="md:w-2/3 select-none">
                        <div>
                            ...
                            <span className=" md:hidden flex items-start gap-8"> <Image className=" rounded-full" src={'https://i.postimg.cc/ZYDgZQyF/aiag-logo.jpg'} alt="" width={70} height={70} />Changes AIAG <br /> CAM {AIAG_VERSION}</span>
                            </h1>
