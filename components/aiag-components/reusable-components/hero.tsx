                ...
                <div className="div-center-md md:py-12 py-0">
                    <div className="md:w-2/3 select-none">
                        <div>
                            ...
                            <span className=" md:flex  hidden items-start gap-8"> <Image className=" rounded-full" src={'https://i.postimg.cc/ZYDgZQyF/aiag-logo.jpg'} alt="" width={90} height={90} />Changes AIAG Content <br /> Action Model {AIAG_VERSION}</span>
