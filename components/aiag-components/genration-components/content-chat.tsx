...
// 2. Renamed the `chatPdfInfo` prop to `chatFileInfos` to align with the new multi-file data structure.
// 3. Updated the props passed to `FileDropzone`, sending `chatFileInfos` to `initialFileInfos` and `onChatFileChange` to `onFilesChange`.
