...
const AiChatList = ({ chatHistory, isResponding, handleRewriteMessage, handleDeleteMessage, handleEditUserMessage, handleRateMessage }: AiChatListProps) => {
    ...
    return (
        <ChatContainerRoot className="h-full">
            <ChatContainerContent className="space-y-0 py-12">
                ...
                {isResponding && (
                    <Message className="mx-auto mt-3 flex w-full max-w-4xl flex-col gap-2 px-6 items-start">
...
const AssistantMessage = ({ message, index, isLastMessage, isRewriteActive, onToggleRewrite, onSelection, onRate }: AssistantMessageProps) => {
    ...
    return (
        <Message className="mx-auto flex w-full max-w-4xl flex-col gap-2 px-6 items-start">
...
const UserMessage = ({ message, index, isLastMessage, onDelete, onEdit }: UserMessageProps) => {
    const [isCopied, setIsCopied] = useState(false)
    ...
    return (
        <Message className="mx-auto flex w-full max-w-4xl flex-col gap-2 px-6 items-end">
