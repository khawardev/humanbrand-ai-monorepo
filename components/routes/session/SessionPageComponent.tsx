...
const ModelsSection = dynamic(() => import('@/components/shared/selections/ModelsSection').then(mod => mod.ModelsSection))
const AudienceSection = dynamic(() => import('@/components/shared/selections/AudienceSection').then(mod => mod.AudienceSection))
const SubjectSection = dynamic(() => import('@/components/shared/selections/SubjectSection').then(mod => mod.SubjectSection))
const ContentTypeSection = dynamic(() => import('@/components/shared/selections/ContentTypeSection').then(mod => mod.ContentTypeSection))
const SocialPlatformSection = dynamic(() => import('@/components/shared/selections/SocialPlatformSection').then(mod => mod.SocialPlatformSection))
const CtaSection = dynamic(() => import('@/components/shared/selections/CtaSection').then(mod => mod.CtaSection))
const ReferenceMaterialSection = dynamic(() => import('@/components/shared/selections/ReferenceMaterialSection').then(mod => mod.ReferenceMaterialSection))
const AdditionalInstructionsSection = dynamic(() => import('@/components/shared/selections/AdditionalInstructionsSection').then(mod => mod.AdditionalInstructionsSection))
const ContextualAwarenessSection = dynamic(() => import('@/components/shared/selections/ContextualAwarenessSection').then(mod => mod.ContextualAwarenessSection))
                ...
                tabs={[
                    {
                        ...
                        icon: <PiBrain />,
                        content: (
                            <section className="space-y-10" ref={contentRef}>
