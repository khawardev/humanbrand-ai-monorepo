...
export const contentTypes = [
    ...
    { id: 10, label: "Thought Leadership Article", Icon: FaLightbulb, color: COLOR_PINK },
    { id: 11, label: "Advertising Copy", Icon: MdSell, color: COLOR_PRIMARY },
    { id: 12, label: "Website Copy Block", Icon: MdContentCopy, color: COLOR_PINK },
];

export const ctas = [
    { id: 1, label: "Register for Event", Icon: MdCalendarMonth, color: COLOR_PINK },
    { id: 2, label: "Download Document", Icon: FaDownload, color: COLOR_PRIMARY },
    { id: 3, label: "Visit Website", Icon: MdOpenInNew, color: COLOR_PINK },
    { id: 4, label: "Join AIAG Membership", Icon: FaUserPlus, color: COLOR_PRIMARY },
    { id: 5, label: "Contact AIAG Support", Icon: FaHeadset, color: COLOR_PINK },
    { id: 6, label: "Schedule Training", Icon: MdSchedule, color: COLOR_PRIMARY },
    { id: 7, label: "Access AI (AVA)", Icon: MdSmartToy, color: COLOR_PINK },
    { id: 8, label: "Purchase Standard", Icon: MdShoppingBag, color: COLOR_PINK },
    { id: 9, label: "Follow on Social Media", Icon: MdShare, color: COLOR_PRIMARY },
    { id: 10, label: "Subscribe to Newsletter", Icon: MdRssFeed, color: COLOR_PINK },
];

export const socialPlatforms = [
    { id: 1, label: "LinkedIn", Icon: FaLinkedin, color: COLOR_PRIMARY },
    { id: 2, label: "Facebook", Icon: FaFacebook, color: COLOR_PINK },
    { id: 3, label: "X", Icon: FaTwitter, color: COLOR_PRIMARY },
    { id: 4, label: "YouTube", Icon: FaYoutube, color: COLOR_PRIMARY },
    { id: 5, label: "Instagram", Icon: FaInstagram, color: COLOR_PINK },
...
export const campaignTypes = [
    ...
    { id: 2, label: "Event or Summit Promo", Icon: MdEvent, color: COLOR_PINK },
    { id: 3, label: "Training & Certifications", Icon: MdSchool, color: COLOR_PRIMARY },
    { id: 4, label: "Membership Growth & Retention", Icon: MdTrendingUp, color: COLOR_PINK },
];
